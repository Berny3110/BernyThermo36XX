// script.js - VERSION CORRIGÉE SCROLL MOBILE
...
function initializeApp() {
    ...
    // === 4. LOGIQUE ROUES (SWIPE) - VERSION CORRIGÉE ===
        ...
        const onEnd = (e) => {
            ...
            if (!isRepeating) {
                ...
                if (newIndex < centerStart) {
                    ...
                    // Trop bas → téléporte vers le haut
